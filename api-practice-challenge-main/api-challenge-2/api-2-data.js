...
const carDetails = (datas) => {
  ...
  for(const data of datas){
    ...
    <img src="${data.imageURL}" class="card-img-top img-fluid" alt="...">
      <div class="card-body">
        <h2 class="card-title">Car Name: ${data.name}</h2>
        <h5 class="card-text mt-3">Car Details: ${data.description}</h5>

        <button class="btn btn-primary py-2 mt-3">Car Price: ${data.price} </button>
      </div>
    </div>
    `
